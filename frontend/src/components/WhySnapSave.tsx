...
import { Zap, Smartphone, Eye, Layers, ShieldCheck, Globe } from "lucide-react";
import { useLanguage } from "@/i18n";

const ICONS = [Zap, Smartphone, Eye, Layers, ShieldCheck, Globe];
const TINTS = ["orange", "orange", "orange", "purple", "purple", "purple"] as const;
...
export default function WhySnapSave() {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 max-w-[1040px] mx-auto">
          {t.why.items.map((card, i) => {
            const s = tintStyles[TINTS[i]];
            const Icon = ICONS[i];
            return (
              <div
                key={i}
